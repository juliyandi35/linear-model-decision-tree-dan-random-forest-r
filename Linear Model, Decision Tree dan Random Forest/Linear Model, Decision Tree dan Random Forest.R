...
library(randomForest)
set.seed(222)
rf_model2<-randomForest(SalePrice~., data = train, mtry=2)
rf_model2
...
library(randomForest)
set.seed(222)
rf_model2_over<-randomForest(SalePrice~., data = over, mtry=2)
rf_model2_over
...
library(randomForest)
set.seed(222)
rf_model2_under<-randomForest(SalePrice~., data = under, mtry=2)
rf_model2_under
...
library(randomForest)
set.seed(222)
rf_model2_smote<-randomForest(SalePrice~., data = smote, mtry=2)
rf_model2_smote
